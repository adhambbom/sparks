...
export const SIGNATURE_BY_FACTION: Record<FactionId, EntitySignature> = {
  ...
  // NPC / boss fallbacks — never deployed but kept for type safety.
  npc_friendly: {
    id: 'sig_operator_strike',
    name: 'OPERATOR STRIKE',
    flavor: 'Direct manual override. Rare but precise.',
...
export const TRAIT_BY_ROLE: Record<MinionRole, EntityTrait> = {
  ...
  swarm: {
    id: 'trait_swarm',
    name: 'SWARM',
    flavor: 'Distributed chassis. Many small units, one signal.',
    effectText: 'Overwhelms with numbers while deployed.',
    color: '#9cff5c',
    glyph: '⁂',
  },
};
