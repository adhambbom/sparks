...
export const SIGNATURE_BY_FACTION: Record<FactionId, EntitySignature> = {
  ...
  // Non-deployable factions — kept for exhaustive type safety.
  npc_friendly: {
    id: 'sig_operator_strike',
    name: 'OPERATOR STRIKE',
    flavor: 'Direct manual override. Rare but precise.',
...
export const TRAIT_BY_ROLE: Record<MinionRole, EntityTrait> = {
  ...
  swarm: {
    id: 'trait_overrun',
    name: 'OVERRUN',
    flavor: 'Disposable units flood the lane. Numbers over armor.',
    effectText: 'Basic attacks apply a stacking bleed each hit.',
    color: '#9cff5c',
    glyph: '∴',
  },
};
