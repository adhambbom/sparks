...
export const SIGNATURE_BY_FACTION: Record<FactionId, EntitySignature> = {
  ...
  // Non-combat/boss fallbacks — never deployed but kept for type safety.
  npc_friendly: {
    id: 'sig_operator_strike',
    name: 'OPERATOR STRIKE',
    flavor: 'Direct manual override. Rare but precise.',
...
export const TRAIT_BY_ROLE: Record<MinionRole, EntityTrait> = {
  ...
  swarm: {
    id: 'trait_swarm',
    name: 'SWARM',
    flavor: 'Numbers over armor. Redundant units keep firing.',
    effectText: 'Basic attacks strike twice for reduced damage.',
    color: '#9cff5c',
    glyph: '≡',
  },
};
